...
from config_manager.eucalyptus.topology.network.edge_subnet import Edge_Subnet
import copy
import re
import ipaddr
import socket
...
class Edge_Network_Config(BaseConfig):
    ...
    def __init__(self,
        ...
        super(Edge_Network_Config, self).__init__(name=name,
