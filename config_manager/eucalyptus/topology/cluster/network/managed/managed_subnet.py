...
class Managed_Subnet(BaseConfig):
    ...
    def __init__(self,
                 ...
                 version=None,
                 network_type=None):
        description = description or "Eucalyptus Managed Subnet Configuration Block."
        name = name or str(subnet)
        self._subnet_ipaddr_obj = None
        if gateway:
            print "DEBUG: Gateway is not used in managed mode"
        ...
        super(Subnet, self).__init__(name=name,
                                     ...
                                     version=version)
    def configure_network(self, subnet):
        """
